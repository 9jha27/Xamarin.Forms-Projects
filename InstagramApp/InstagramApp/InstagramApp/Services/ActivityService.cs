...
namespace InstagramApp.Services
{
    ...
    {
		public IEnumerable<Activity> GetActivities() //this iterates through the new List<Activity>
		{
			return new List<Activity>
			{
				new Activity {UserId=1, Description="Your friend, Ashley, just posted a new photo."},
				new Activity {UserId=2, Description="Tom Seguo just started following you."},
